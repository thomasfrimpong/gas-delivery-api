...
<nav class="mt-2">
    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="/cylinders" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Cylinders</p>
                </a>
              </li>
                        ...
                        <div class="col-lg-12">
                            <div class="card card-info card-outline">
                                <div class="card-header">
                                  <h3 class="card-title">List Of Cylinders</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                  
                                  <button type="button" class="btn btn-info" data-toggle="modal" data-target="#add-cylinder-modal">
                                    Add Cylinder
                                  </button>
                                  <br><br>
                                  <table id="example1" class="table table-bordered table-striped"   >
                                    <thead>
                                      <tr>
                                        <th>Size Of Cylinder(kg)</th>
                                        <th>Cost Per Unit (GHC)</th>
                                        <th>Units Available(No.)</th>
                                       <th>Action(s)</th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>{{$cylinder->size_of_cylinder}}</td>
                                        <td>{{ $cylinder->cost_per_unit}}
                                        </td>
                                        <td>{{ $cylinder->number_of_units_available}}</td>
